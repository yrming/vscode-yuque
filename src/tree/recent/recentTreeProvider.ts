...
export class RecentTreeProvider implements vscode.TreeDataProvider<DocsTreeItem> {
    ...
    constructor(private context: vscode.ExtensionContext, private client: any, private user: YuqueUserDetail, private recentDocsChangeEventEmitter: vscode.EventEmitter<void>) {
